...
export class SkillsComponent implements AfterViewInit, OnDestroy {
  ...
  skills: Skill[] = [
    ...
    { name: 'Angular', category: 'frontend', pct: 75, level: '', icon: '/images/svg/angular.svg', color: '#ff5470', iconBg: '' },
    { name: 'JavaScript', category: 'frontend', pct: 75, level: '', icon: '/images/svg/javascript.svg', color: '#f0b429', iconBg: '' },
    ...
    { name: 'MongoDB', category: 'backend', pct: 50, level: '', icon: '/images/svg/mongo.svg', color: '#2ee584', iconBg: '' },
